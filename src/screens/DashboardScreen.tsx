        ...
        {promos.map((p) => (
          ...
          >
            {p.logo ? (
              ...
              <View
                style={[
                  localStyles.promoLogo,
                  { backgroundColor: p.color, justifyContent: 'center', alignItems: 'center' },
                ]}
              >
            ...
            <View>
              ...
              <Text style={localStyles.promoDesc} numberOfLines={1}>
                {p.name}
              </Text>
            </View>
