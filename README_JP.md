...
ユーザーのプライバシーとセキュリティを最優先に設計されています。

🔗 **公式サイト:** [https://RamyaParryk.github.io/RamyaWallet/](https://RamyaParryk.github.io/Ramya-Wallet/)
...
* **🔄 スワップ:** **Jupiter Aggregator** を搭載。常に最適なレートでトークンを交換できます。
